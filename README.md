...
![Snake II](Snake%20ii%20SS%201.png)

<p align="center">
  <img src="Snake%20ii%20SS%202.png" width="200">
  <img src="Snake%20ii%20SS%203.png" width="200">
  <img src="Snake%20ii%20SS%204.png" width="200">
  <img src="Snake%20ii%20SS%205.png" width="200">
</p>
...
The game is a single HTML file with everything inline — no build step, no dependencies. The `<script>` block is divided into 13 numbered sections:
...
| 8. Effects       | Particles, screen shake, score pop                      |
| 9. Game logic    | One game step (move, eat, collide)                      |
| 10. Render       | Draw the world with smooth tick interpolation           |
| 11. Main loop    | `requestAnimationFrame` loop, ticks at the snake speed  |
...
Built by [**Omar Alzand**](https://github.com/OmarAlzand) in collaboration with [**Claude Opus 4.7**](https://www.anthropic.com/claude) — Anthropic's flagship model for coding and creative work. The entire codebase was iterated through long-form conversation: game-feel research, smooth tick interpolation, audio synthesis, anti-cheat design, and dozens of bug fixes — all produced through dialogue rather than autocomplete.
